...
public class MeninMiddleAttack {
    ...
    public static void main(String[] args) {
        ...
        if(checkPRoot(p,g)==true)
        {
           ...
           //darth send the key to alice and bob
           int Ia=(int)pow(g,db)%p;
           int Ib =(int)pow(g,da)%p;
           ...
           System.out.println("ka="+kda);
           System.out.println("kb="+kdb);
        }
        else
        {
            System.out.printf("%d is not Primitve root\n",g);
        }
